...
Description: script that gives the dodule of session authenticating views.
"""
...
def login() -> Tuple[str, int]:
    """ login fxn that returns JSON representation of a User object """
...
def logout() -> Tuple[str, int]:
    """ logout fxn that returns empty JSON object """
